...
class Header extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            followList: [0, 1, 2],
            followContent: ["fab fa-facebook", "fab fa-twitter", "fab fa-github"],
            followLinks: ["https://www.facebook.com/Mrthanhdanhnguyen", "https://twitter.com/tthanhnguyenn", "https://github.com/danhthanhnguyen"],
    ...
    render() {
        const menu = this.state.menuList.map((items) =>
        <li key={items.toString()} className="tim9 tim17"><a className="scroll" href={this.state.connect[items]}><span className="tim10">{this.state.menuContent[items]}</span><span className="tim11 tim18"></span></a></li>);
        const follow = this.state.followList.map((items) =>
        <li key={items.toString()} className="tim12 tim17"><a href={this.state.followLinks[items]} target="_blank" rel="noopener noreferrer"><i className={this.state.followContent[items]}></i></a><span className="tim13 tim18"></span></li>);
        return (
            <div className="tim1">
                <div className="tim2">
